"""MindSpore Vision 3D training script."""
...
from mindvision.engine.dataset.builder import build_dataset, build_transforms
from mindvision.ms3d.models import build_classifier
