...
def train_net():
    ...
    # Data Pipeline.
    mri_data_train = S3DISDataset(split="train",num_points=config.num_point,test_area=config.test_area)
    ...
    mri_data_val = S3DISDataset(split='test',num_points=config.num_point,test_area=config.test_area)
